...
#if 0
std::cout<<"pre 0["<<KZ<<",  "<<RHO[0]<<",  "<<IRHO[0]<<",  "<<RHOM[0]<<" ]"<<std::endl;
std::cout<<"pre 1["<<IP<<",  "<<RHO[1]<<",  "<<IRHO[1]<<",  "<<RHOM[1]<<" ]"<<std::endl;
std::cout<<"pre E0["<<E0<<",  "<<BLP<<",  "<<GLP<<",  "<<FS1S1<<" ]"<<std::endl;
std::cout<<"pre S1["<<S1L<<",  "<<S1LP<<",  "<<DELTA<<",  "<<B11<<" ]"<<std::endl;
#endif
        Z += D[LP];
        L = LP;
      }
...
std::cout<<"kzi="<<KZ<<" layer="<<1<<" B11="<<B11<<std::endl;
...
#if 0
std::cout<<"===== B ===="<<std::endl;
std::cout<<"kzi="<<KZ<<" layer="<<L<<" B11="<<B11<<std::endl;
std::cout<<"["<<B11<<" "<<B12<<" "<<B13<<" "<<B14<<"]"<<std::endl;
std::cout<<"["<<B21<<" "<<B22<<" "<<B23<<" "<<B24<<"]"<<std::endl;
std::cout<<"["<<B31<<" "<<B32<<" "<<B33<<" "<<B34<<"]"<<std::endl;
std::cout<<"["<<B41<<" "<<B42<<" "<<B43<<" "<<B44<<"]"<<std::endl;
