...
cdouble u1(global const cdouble *L, int j);
cdouble u3(global const cdouble *L, int j);
...
cdouble u1(global const cdouble *L, int j)   { return L[j*4+1]; }
cdouble u3(global const cdouble *L, int j)   { return L[j*4+2]; }
...
*/
    ...
    S1p = cneg(csqrt(csub(rmul(PI4,radd(+rhoB(L,0), rhoN(L,0))), E0)));
    S3p = cneg(csqrt(csub(rmul(PI4,radd(-rhoB(L,0), rhoN(L,0))), E0)));

#if 1
    Bn = u1(L,1);
    //Gn = rdiv(1,u3(L,1));
    Gn = u3(L,1);
    S1n = cneg(csqrt(csub(rmul(PI4,radd(+rhoB(L,1), rhoN(L,1))), E0)));
    S3n = cneg(csqrt(csub(rmul(PI4,radd(-rhoB(L,1), rhoN(L,1))), E0)));
#else
    if (cabs(u1(L,1)) <= 1.0) {
        Bn = u1(L,1);
        Gn = rdiv(1,u3(L,1));
...
printf("[%g%+gj %g%+gj %g%+gj %g%+gj]\n",creal(S1p),cimag(S1p),creal(S1n),cimag(S1n),creal(delta),cimag(delta),creal(B11),cimag(B11));
}
#endif
        }
        {
...
printf("[%10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj]\n",creal(B11),cimag(B11),creal(B12),cimag(B12),creal(B13),cimag(B13),creal(B14),cimag(B14));
printf("[%10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj]\n",B21,B22,B23,B24);
printf("[%10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj]\n",B31,B32,B33,B34);
printf("[%10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj %10.6g%+10.6gj]\n",B41,B42,B43,B44);
}
